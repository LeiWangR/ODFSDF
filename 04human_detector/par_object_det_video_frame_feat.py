...
# python par_object_det_video_frame_feat.py -hdf5_dir 'par_part_feat_sample.hdf5' -rgb_dir '/home/wan305/research/ongoing/lei/00opt_rgb_prep/sample_mpii/rgb' -model_path '/home/wan305/research/ongoing/lei/04human_detector/faster_rcnn_inception_resnet_v2_atrous_coco_2018_01_28/frozen_inference_graph.pb' -subfolder_names 's20-d07-cam-002_05491_052_split_s20-d07-cam-002_05493_034_split_s20-d07-cam-002_05495_042_split_s20-d07-cam-002_05497_052'
...
parser.add_argument("-hdf5_dir","--hdf5_dir",type=str,default='par_part_feat_sample.hdf5')
parser.add_argument("-subfolder_names","--subfolder_names",type=str,default='s20-d07-cam-002_05491_052_split_s20-d07-cam-002_05493_034_split_s20-d07-cam-002_05495_042_split_s20-d07-cam-002_05497_052')
...
subfolder_names = args.subfolder_names
subfolder_name = subfolder_names.split('_split_')

print('processing ', len(subfolder_name), 'files')

odapi = DetectorAPI(path_to_ckpt=model_path)

with h5py.File(hdf5_name, 'w') as fo:
    for ii in subfolder_name:
        video_folder = rgb_path + '/' + ii
        for r, d, f in os.walk(video_folder, followlinks = False):
            f.sort()
            if len(f) == 0:
                print('empty!')
                continue;

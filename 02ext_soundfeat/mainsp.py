...
# for Moments in time dataset
# python mainsp.py -trteset 'training' -splitnum 1
# python mainsp.py -trteset 'training' -splitnum 2
# python mainsp.py -trteset 'training' -splitnum 3
# python mainsp.py -trteset 'training' -splitnum 4
# python mainsp.py -trteset 'training' -splitnum 5
# python mainsp.py -trteset 'training' -splitnum 6
...
parser.add_argument("-splitnum","--splitnum",type=int,default=1)
...
audiofeat_save = './moments_in_time_soundnet8_pool5_feat_' + args.trteset + '_p' + str(args.splitnum) + '.pickle'
...
for ii in range(dfinfo.shape[0]):
    if ii >= (args.splitnum - 1) * 134000 and ii <= (args.splitnum - 1) * 134000 + 133999:
